...
export const PRODUCTS: Product[] = [
  ...
  // 精油系列
  {
    ...
    pv: 833,
    benefitCards: [
      { title: '舒緩放鬆', description: '橙花與天竺葵精油的天然芳香，幫助放鬆身心、舒緩日常壓力。' },
      { title: '深層保濕', description: '甜杏仁油與甘油深層滋養乾燥肌膚，回復柔嫩細緻的觸感。' },
      { title: '平衡油水', description: '幫助維持肌膚油水平衡，適合各類膚質作為日常身體護理。' },
      { title: '亮采修護', description: '橙花精油溫和調理膚色，基礎修護暗沉，重現澄淨亮采光澤。' },
    ],
    forYou: [
    ...
    experience: [
      ...
      { icon: 'flower', title: '天然植萃香氣', description: '散發苦橙花與天竺葵的天然舒壓清香' },
    ],
    ...
    ingredients: '甜杏仁油、橙花精油、天竺葵精油、甘油',
    storage: '存放於陰涼乾燥處。\n避免陽光直射及潮濕環境。'
  },
  {
    id: 'Q2',
    ...
    pv: 918,
    benefitCards: [
      { title: '舒緩修護', description: '薰衣草萃取能安撫換季乾癢與泛紅不適，在塗抹過程中幫助穩定膚況、放鬆身心壓力。' },
      { title: '澎潤彈性', description: '玻尿酸高效保濕補水，修護肌膚，維持細緻年輕感。' },
      { title: '滑嫩膚觸', description: '甜杏仁油能修護乾燥的身體肌膚，使觸感變得絲滑柔軟。' },
      { title: '深層補水', description: '玻尿酸能迅速為肌膚大量抓水鎖水，改善乾裂與脫屑，重現水潤透亮的自然光澤。' },
    ],
    forYou: [
