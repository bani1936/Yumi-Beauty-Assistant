...
export const PRODUCTS: Product[] = [
  // 熨斗系列(小)
  {
    ...
    image: '/product_image_5b212e85.jpg',
    benefits: ['修護', '晶亮', '緊緻'],
    size: '小',
    volume: '30ml',
    pv: 2533,
  ...
  },
  {
    ...
    image: '/202411181659300_28605e94.jpg',
    benefits: ['柔敏', '美白', '噫液'],
    size: '小',
    volume: '120ml',
    pv: 2250
    ...
    pv: 5253},
  {
    ...
    memberPrice: 8180,
    description: '使肌膚補充水分，使肌膚光滑、水嫩，白天防曬後仍可補水保濕',
    image: '/202412121542260_b3771d19.jpg',
    benefits: ['柔敏', '美白', '精華'],
    size: '大',
    volume: '500ml',
    pv: 6783},
  ...
  // 都都好系列 (38系列)
  {
    ...
    image: '/pasted_file_WqXUaV_image_8e0081eb.png',
    benefits: ['控油', '抵痘', '亮顧'],
    size: '標準',
    volume: '30ml',
    pv: 2250
  ...
  },
  {
    ...
    image: '/pasted_file_DyPkRV_image_5897d2d9.png',
    benefits: ['舅緩', '保濕', '吸收'],
    size: '標準',
    volume: '30ml',
    pv: 2250
  },
  {
    ...
    image: '/pasted_file_7VVMoc_image_d64ffbe0.png',
    benefits: ['修護', '保護', '強化'],
    size: '標準',
    volume: '60ml',
    pv: 2250
  },
  {
    ...
    image: '/pasted_file_KCYzkD_image_343d26d7.png',
    benefits: ['凝露', '滋養', '精華'],
    size: '標準',
    volume: '50ml',
    pv: 2250
  ...
  },
  {
    ...
    image: '/pasted_file_BETZb6_image_533860ef.png',
    benefits: ['精華', '粉體', '高效'],
    size: '標準',
    volume: '10件組',
    pv: 3740
  ...
  // 淨膚系列 (58系列)
  {
    ...
    image: '/pasted_file_ZKyhqr_image_51d1a3cb.png',
    benefits: ['清潔', '穩定', '溫和'],
    size: '標準',
    volume: '30ml',
    pv: 2533
  },
  {
    ...
    image: '/pasted_file_6yK3OT_image_e3ac347a.png',
    benefits: ['修護', '舒緩', '敏感'],
    size: '標準',
    volume: '30ml',
    pv: 2250
  ...
  },
  {
    ...
    image: '/pasted_file_Mrv1fb_image_1c963aa7.png',
    benefits: ['精華', '粉體', '經濟'],
    size: '標準',
    volume: '3件組',
    pv: 1122
  ...
  // 晶亮系列 (D系列)
  {
    ...
    image: '/pasted_file_s3tlrn_image_ebd6c976.png',
    benefits: ['晶亮', '光澤', '恢復'],
    size: '標準',
    volume: '30ml',
    pv: 2250
  },
  {
    ...
    image: '/pasted_file_q2SmXV_image_ae2da8f3.png',
    benefits: ['柔敏', '溫和', '有效'],
    size: '標準',
    volume: '30ml',
    pv: 2250
  ...
  },
  {
    ...
    price: 4400,
    description: '粉液結合，雙重功效',
    image: '/pasted_file_Res3uV_image_83b930ea.png',
    benefits: ['精華', '粉體', '高效'],
    size: '標準',
    volume: '10件組',
    pv: 3740
  ...
  // Q彈精緻系列 (68系列)
  {
    ...
    image: '/pasted_file_dr3ICP_image_2d9c0af8.png',
    benefits: ['膠原', '滋養', '再生'],
    size: '標準',
    volume: '50ml',
    pv: 2250
  },
  {
    ...
    image: '/pasted_file_CYH1xV_image_2e9f1657.png',
    benefits: ['Q彈', '滋養', '精緻'],
    size: '標準',
    volume: '30ml',
    pv: 2250
  ...
  },
  {
    ...
    image: '/pasted_file_N7aotw_image_1f77d140.png',
    benefits: ['Q彈', '精緻', '活力'],
    size: '標準',
    volume: '30ml',
    pv: 2533
  ...
  },
  {
    ...
    price: 4400,
    description: '粉液結合，雙重功效',
    image: '/pasted_file_sWacuf_image_b7cdd9f2.png',
    benefits: ['精華', '粉體', '高效'],
    size: '標準',
    volume: '10件組',
    pv: 3740
...

  {
    ...
    image: '/pasted_file_T24V5r_image_193043c4.png',
    benefits: ['玉瑰爡', '角質', '清潔'],
    size: '標準',
    volume: '80ml',
    pv: 680
  },
  {
    ...
    image: '/pasted_file_li4fqq_image_73e2ef5b.png',
    benefits: ['保濕', '滋養', '解渴'],
    size: '標準',
    volume: '30ml',
    pv: 2250
  ...
  },
  {
    ...
    image: '/pasted_file_oTOjuE_image_219ac5fe.png',
    benefits: ['調理', '平衡', '油水'],
    size: '標準',
    volume: '60ml',
    pv: 2250
  ...
  },
  {
    ...
    image: '/pasted_file_QzLRuM_image_f9ba00df.png',
    benefits: ['好皮敷', '凝露', '滋養'],
    size: '標準',
    volume: '50ml',
    pv: 2250
  ...
  },
  {
    ...
    image: '/pasted_file_PlufKg_image_4e0159e1.png',
    benefits: ['定點', '精華', '集中'],
    size: '標準',
    volume: '30ml',
    pv: 2533
  ...
  // 精油系列
  {
    ...
    image: '/pasted_file_NUUuwX_image_8b16a72e.png',
    benefits: ['草本', '安撫', '舒緩'],
    size: '標準',
    volume: '100ml',
    pv: 833,
  ...
  },
  {
    ...
    image: '/pasted_file_tQXxJf_image_ff444869.png',
    benefits: ['草本', '通暢', '活化'],
    size: '標準',
    volume: '100ml',
    pv: 918,
