...
export const PRODUCTS: Product[] = [
  ...
  },
 {
    ...
    usage: '內含50%防曬隔離效果與50%保養成分',
    instructions: '在上完所有保養品之後，取適量均勻塗抹全臉',
    storage: '存放於陰涼乾燥處，避免陽光直射',
...
},
  {
    ...
    storage: '存放於陰涼乾燥處，避免陽光直射',
    precautions: [
      '月見草油是女性聖品，能使皮膚遇到紫外線傷害時，與防塵隔離成分互相配合，一邊防塵隔離一邊修補',
      '石榴果皮萃取能夠有效中和自由基，抵禦光老化與環境壓力對肌膚造成的傷害，延緩肌膚鬆弛，抑制黑色素生成'
    ]
},
  {
    id: '26-2',
